...
#' @param param_list A list composed of the models, named as in the models parameter, and the respective parameters included in the models.
#' @param silent A logical value defining whether warnings should be printed during the model fitting. The default value is TRUE (not printing warnings).
#' @importFrom stats na.exclude
#' @return A list containing the fitted models, the model's weights and ranks for each weighting strategy, and the predicted daily production obtained through the model ensemble for each weighting strategy.
#' @export
